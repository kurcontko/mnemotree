...
from .query import MemoryFilter, MemoryQuery, MemoryQueryBuilder, FilterOperator
...
class MemoryCore:
    ...
    def __init__(
        ...
        Args:
            ...
            enable_ner: If False, disables entity extraction for this instance.
        """
        self.store = store
        ...
        *,
        ...
        if tasks:
            ...
            if analyze:
                ...
                all_tags = set(tags or []) | set(analysis.tags or [])
            else:
                analysis = None
        ...
        if analysis:
            if analysis.emotions:
                emotions = [str(e) for e in analysis.emotions]
